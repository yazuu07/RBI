...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $result = $stmt->execute([
            ...
            $place_of_birth, $date_of_birth, $age, $sex,
            $civil_status, $citizenship, $occupation, $profession,
            $disability, $pets, $profile_picture, $id
        ]);
                        ...
                        <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="place_of_birth" class="form-control" placeholder="City/Municipality, Province" value="<?= htmlspecialchars($record['place_of_birth']) ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="citizenship" class="form-control" placeholder="e.g., Filipino" value="<?= htmlspecialchars($record['citizenship']) ?>">
                                </div>

                                <!-- Occupation & Profession -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Occupation</label>
                                    <input type="text" name="occupation" class="form-control" placeholder="e.g., Teacher" value="<?= htmlspecialchars($record['occupation']) ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Profession (if any)</label>
                                    <input type="text" name="profession" class="form-control" placeholder="e.g., Licensed Professional Teacher" value="<?= htmlspecialchars($record['profession']) ?>">
                                </div>
