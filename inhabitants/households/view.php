...
// Log view action
logAudit($_SESSION['user_id'], 'VIEW', 'household_records', $id, 
    "Viewed household: " . $record['first_name'] . ' ' . $record['last_name']);
...
$stmt = $pdo->prepare("
    ...
    WHERE a.table_name = 'household_records' AND a.record_id = ? 
...
<head>
    ...
    <title>View Household - RBIS</title>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">
                        <i class="fas fa-home text-success"></i> Household Details
                    </h1>
                    <div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="info-value"><?= htmlspecialchars($record['citizenship']) ?: 'N/A' ?></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-label">Occupation</div>
                                        <div class="info-value"><?= htmlspecialchars($record['occupation']) ?: 'N/A' ?></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-label">Profession</div>
                                        <div class="info-value"><?= htmlspecialchars($record['profession']) ?: 'N/A' ?></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-label">Disability</div>
                                        <div class="info-value"><?= htmlspecialchars($record['disability']) ?: 'None' ?></div>
                                    </div>
                                    <div class="col-md-6">
